...
def detect_facets(title: str, description: str, category_slug: str | None = None, query_intent: str | None = None) -> dict:
    ...
    if category_slug in ["perfumes", "niche-artisanal", "oud-oriental"]:
        ...
        # Performance
        if any(w in text for w in ["long lasting", "longevity", "beast mode", "all day"]):
