...
def classify_content_metadata(
    ...
    try:
        ...
        #    The workflow passes composite slugs like "technology:smartphones".
        ...
        # Strip parent prefix from composite discovery keys, e.g. "technology:smartphones" → "smartphones"
        ...
        logger.debug(
            "[INTEGRATION][%s] success  facets=%s",
            _NAME,
        ...
        # Re-raise so the workflow can decide whether to skip this product
        raise
