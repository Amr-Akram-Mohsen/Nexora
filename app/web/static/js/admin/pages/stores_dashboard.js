...
(function () {
  ...
  function loadDashboardStats() {
    window.api.get('/admin/stores/health_stats')
      ...
      .catch(err => console.error('Failed to load stores dashboard stats', err));
  }
  ...
  function loadCoverageStats() {
    window.api.get('/admin/stores/coverage_stats')
      .then(data => {
      ...
      .catch(err => console.error('Failed to load stores coverage stats', err));
  }

  function loadAffiliateStats() {
    window.api.get('/admin/stores/affiliate_stats')
      .then(data => {
  ...
  function loadPricingStats() {
    window.api.get('/admin/stores/pricing_stats')
      .then(data => {
      ...
      .catch(err => console.error('Failed to load pricing stats', err));
  }
