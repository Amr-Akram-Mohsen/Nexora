...
def content_dashboard():
    ...
    return render_template(
        "admin/content_library/dashboard.html",
        stats=get_admin_content_dashboard_stats(),
        domain="content_dashboard",
    )
...
def deduplication_view():
    return render_template(
        "admin/content_library/deduplication.html",
        duplicate_groups=get_admin_deduplication_groups(),
