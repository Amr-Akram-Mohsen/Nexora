...
def post_comment(user, target_type, target_id, content, parent_id):
    ...
    comment = Comment(user_id=user.id, target_type=target_type, target_id=target_id, content=sanitized_content, created_at=created_at, sentiment=sentiment, confidence=confidence, parent_id=parent_id)
