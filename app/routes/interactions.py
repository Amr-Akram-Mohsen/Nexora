...
from app.models import db, NewsletterSubscriber, Reaction, Save, Comment, Article, Item, ItemStoreLink, ItemClick
...
from app.services.interaction_service import react, save_item, post_comment, record_view
from app.services.interest_service import handle_interaction_interest, handle_comment_interaction
from . import bp
