...
def get_item_inspect_workflow(product_id: int) -> dict:
    ...
    return {'item_dto': dto, 'engagement_score': engagement_score, 'distribution_history': distribution_history}
...
def get_item_detail_workflow(product_id):
    ...
    from app.domains.product.serializers import serialize_item_detail_modal
